    ...
    <div class="product-preview-container">
            ...
            <div class="d-flex" >
                <div class="preview-card">
                    <div class="d-flex flex-column thumbnails">
                        <div id="f1" class="tb tb-active" > <img class="thumbnail-img fit-image" src="assets/womens/sweatshirts/daisystreet_sweat_1.jpeg"> </div>
                        <div id="f2" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/sweatshirts/daisystreet_sweat_2.jpeg"> </div>
                        <div id="f3" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/sweatshirts/daisystreet_sweat_3.jpeg"> </div>
                        <div id="f4" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/sweatshirts/daisystreet_sweat_4.jpeg"> </div>
                    </div>
                    <fieldset id="f11" class="active" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/womens/sweatshirts/daisystreet_sweat_1.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f21" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/womens/sweatshirts/daisystreet_sweat_2.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f31" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/womens/sweatshirts/daisystreet_sweat_3.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f41" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/womens/sweatshirts/daisystreet_sweat_4.jpeg"> </div>
                    </fieldset>
                </div>
            </div>
        </div>
      ...
      <div class="right-column">
        <div class="product-title">
          <span>Womens Sweatshirts</span>
          <h3>Daisy Street Oversized Sweatshirt with Athletic Academy Print in Colour Block Co-ord</h3>
          <p>Sweatshirts by Daisy Street: </p>
            <ul class="product-details">
              <li>Colour-block design</li>
              <li>Crew neck</li>
              <li>Drop shoulders</li>
              <li>Collegiate print to chest</li>
              <li>Ribbed trims</li>
              <li>Oversized fit</li>
              <li>Relaxed and roomy</li>
            </ul>
        </div>
        ...
        <form method='post' action='add_to_cart.php'>
          <div class="product-colour">
            <span><strong>Colour:</strong> Navy/Gray Colour Block</span>
          </div>
