<?php
  ...
  session_start();
  $item_name = 'womens-leather-jacket';
  ...
  <div class="container-fluid">
          ...
          <div class="d-flex" >
              <div class="preview-card">
                  <div class="d-flex flex-column thumbnails">
                      <div id="f1" class="tb tb-active" > <img class="thumbnail-img fit-image" src="assets/womens/coats/asos_jacket_1.jpeg"> </div>
                      <div id="f2" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/coats/asos_jacket_2.jpeg"> </div>
                      <div id="f3" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/coats/asos_jacket_3.jpeg"> </div>
                      <div id="f4" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/coats/asos_jacket_4.jpeg"> </div>
                  </div>
                  <fieldset id="f11" class="active" style="border: none;">
                      <div class="product-pic"> <img class="pic0" src="assets/womens/coats/asos_jacket_1.jpeg"> </div>
                  </fieldset>
                  <fieldset id="f21" class="" style="border: none;">
                      <div class="product-pic"> <img class="pic0" src="assets/womens/coats/asos_jacket_2.jpeg"> </div>
                  </fieldset>
                  <fieldset id="f31" class="" style="border: none;">
                      <div class="product-pic"> <img class="pic0" src="assets/womens/coats/asos_jacket_3.jpeg"> </div>
                  </fieldset>
                  <fieldset id="f41" class="" style="border: none;">
                      <div class="product-pic"> <img class="pic0" src="assets/womens/coats/asos_jacket_4.jpeg"> </div>
                  </fieldset>
              </div>
          </div>
      </div>
    ...
    <div class="right-column">
      <div class="product-title">
        ...
        <h3>Ultimate Faux Leather Jacket</h3>
        <p>Jackets by Ultimate: </p>
          <ul class="product-details">
            <li>Layered looks </li>
            <li>Studded notch lapels</li>
            <li>Zip fastening </li>
            <li>Side pockets</li>
            <li>Regular fit</li>
            <li>True to size</li>
