<?php
  ...
  session_start();
  $item_name = 'jack-and-jones-jeans';
    ...
    <div class="product-preview-container">
            ...
            <div class="d-flex" >
                <div class="preview-card">
                    <div class="d-flex flex-column thumbnails">
                        <div id="f1" class="tb tb-active" > <img class="thumbnail-img fit-image" src="assets/mens/trousers/jack_jeans_1.jpeg"> </div>
                        <div id="f2" class="tb"> <img class="thumbnail-img fit-image" src="assets/mens/trousers/jack_jeans_2.jpeg"> </div>
                        <div id="f3" class="tb"> <img class="thumbnail-img fit-image" src="assets/mens/trousers/jack_jeans_3.jpeg"> </div>
                        <div id="f4" class="tb"> <img class="thumbnail-img fit-image" src="assets/mens/trousers/jack_jeans_4.jpeg"> </div>
                    </div>
                    <fieldset id="f11" class="active" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/mens/trousers/jack_jeans_1.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f21" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/mens/trousers/jack_jeans_2.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f31" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/mens/trousers/jack_jeans_3.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f41" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/mens/trousers/jack_jeans_4.jpeg"> </div>
                    </fieldset>
                </div>
            </div>
        </div>
      ...
      <div class="right-column">
        <div class="product-title">
          ...
          <h3>Jack & Jones Intelligence Liam Skinny Fit Stretch Jeans in Mid Blue</h3>
          <p>Jeans by Jack&Jones: </p>
            <ul class="product-details">
              ...
              <li>Five pockets </li>
              <li>Skinny fit</li>
              <li>Cut very closely from hips to hem</li>
            </ul>
        </div>
        ...
        <form method='post' action='add_to_cart.php'>
          <div class="product-colour">
            <span><strong>Colour:</strong> Blue Denim</span>
          </div>
            ...
            <div class="choose-size">
             ...
             <div class="form-group">
                <select name="size" class="form-control" id="exampleFormControlSelect1" required>
                  ...
                  <option>W27 L32</option>
                  <option>W28 L30</option>
                  <option>W28 L32</option>
                  <option>W28 L34</option>
                  <option>W29 L30</option>
                  <option>W29 L32</option>
                  <option>W29 L30</option>
                  <option>W30 L30</option>
                  <option>W30 L32</option>
                  <option>W30 L34</option>
                  <option>W32 L30</option>
                  <option>W32 L32</option>
                  <option>W32 L34</option>
                </select>
              </div>
            </div>
            <div>
