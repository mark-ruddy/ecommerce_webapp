    ...
    <div class="product-preview-container">
            ...
            <div class="d-flex" >
                <div class="preview-card">
                    <div class="d-flex flex-column thumbnails">
                        <div id="f1" class="tb tb-active" > <img class="thumbnail-img fit-image" src="assets/womens/tops/stradivarius_top_1.jpeg"> </div>
                        <div id="f2" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/tops/stradivarius_top_2.jpeg"> </div>
                        <div id="f3" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/tops/stradivarius_top_3.jpeg"> </div>
                        <div id="f4" class="tb"> <img class="thumbnail-img fit-image" src="assets/womens/tops/stradivarius_top_4.jpeg"> </div>
                    </div>
                    <fieldset id="f11" class="active" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/womens/tops/stradivarius_top_1.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f21" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/womens/tops/stradivarius_top_2.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f31" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/womens/tops/stradivarius_top_3.jpeg"> </div>
                    </fieldset>
                    <fieldset id="f41" class="" style="border: none;">
                        <div class="product-pic"> <img class="pic0" src="assets/womens/tops/stradivarius_top_4.jpeg"> </div>
                    </fieldset>
                </div>
            </div>
        </div>
      ...
      <div class="right-column">
        <div class="product-title">
          ...
          <h3>Stradivarius Slim Fit Ribbed T-shirt with Contrast in White</h3>
          <p>Tops by Stradivarius: </p>
